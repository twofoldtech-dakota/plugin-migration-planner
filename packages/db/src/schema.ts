...
export const clientProficiencies = pgTable(
  "client_proficiencies",
  {
...
export const discoveryDimensions = pgTable(
...
export const activeMultipliers = pgTable(
  "active_multipliers",
  {
    assessment_id: text("assessment_id")
      .notNull()
...
export const dependencyChains = pgTable(
  "dependency_chains",
  {
    assessment_id: text("assessment_id")
      .notNull()
...
export const riskClusters = pgTable(
  "risk_clusters",
  {
    assessment_id: text("assessment_id")
      .notNull()
...
export const estimateComponents = pgTable(
  "estimate_components",
  {
...
export const aiSelections = pgTable(
  "ai_selections",
  {
    assessment_id: text("assessment_id")
      .notNull()
...
export const calibrationPhases = pgTable(
  "calibration_phases",
  {
...
export const calibrationComponents = pgTable(
...
export const calibrationAiTools = pgTable(
  "calibration_ai_tools",
  {
    calibration_id: integer("calibration_id")
      .notNull()
      .references(() => calibrations.id, { onDelete: "cascade" }),
...
export const knowledgePacks = pgTable(
  "knowledge_packs",
  {
    id: text("id").primaryKey(),
    name: text("name").notNull(),
...
export const knowledgePackVersions = pgTable(
...
export const knowledgeDiscoveryTrees = pgTable(
  "knowledge_discovery_trees",
  {
    pack_id: text("pack_id")
      .notNull()
      .references(() => knowledgePacks.id, { onDelete: "cascade" }),
...
export const knowledgeEffortHours = pgTable(
  "knowledge_effort_hours",
  {
    pack_id: text("pack_id")
      .notNull()
      .references(() => knowledgePacks.id, { onDelete: "cascade" }),
...
export const knowledgeMultipliers = pgTable(
...
export const knowledgeGotchaPatterns = pgTable(
  "knowledge_gotcha_patterns",
  {
    pack_id: text("pack_id")
      .notNull()
      .references(() => knowledgePacks.id, { onDelete: "cascade" }),
...
export const knowledgeDependencyChains = pgTable(
...
export const knowledgePhaseMappings = pgTable(
  "knowledge_phase_mappings",
  {
    pack_id: text("pack_id")
      .notNull()
      .references(() => knowledgePacks.id, { onDelete: "cascade" }),
...
export const migrationPaths = pgTable(
  "migration_paths",
  {
    id: text("id").primaryKey(),
...
export const knowledgeAiAlternatives = pgTable(
  "knowledge_ai_alternatives",
  {
    pack_id: text("pack_id")
      .notNull()
      .references(() => knowledgePacks.id, { onDelete: "cascade" }),
...
export const knowledgeSourceUrls = pgTable(
...
export const assessmentKnowledgePins = pgTable(
  "assessment_knowledge_pins",
  {
    assessment_id: text("assessment_id")
      .notNull()
      .references(() => assessments.id, { onDelete: "cascade" }),
...
export const wbsSnapshots = pgTable(
  "wbs_snapshots",
  {
    id: serial("id").primaryKey(),
    assessment_id: text("assessment_id")
