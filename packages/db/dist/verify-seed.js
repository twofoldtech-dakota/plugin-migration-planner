...
async function main() {
    ...
    console.log("  discovery dimensions:", full.discovery_tree?.dimensions_json?.length);
    ...
    console.log("  service_map categories:", Object.keys(path?.service_map ?? {}).length);
    ...
    const computeRole = full.effort_hours?.find((e) => e.component_id === "compute_single_role");
    ...
    const sessionGotcha = full.gotcha_patterns?.find((g) => g.pattern_id === "session_redis_cd");
