...
import {
  getDb,
  saveKnowledgePack as dbSaveKnowledgePack,
  getKnowledgePackById as dbGetKnowledgePackById,
  getKnowledgePackFull as dbGetKnowledgePackFull,
  listKnowledgePacks as dbListKnowledgePacks,
  deleteKnowledgePack as dbDeleteKnowledgePack,
  saveHeuristics as dbSaveHeuristics,
  getHeuristicsForPacks as dbGetHeuristicsForPacks,
  saveDiscoveryTree as dbSaveDiscoveryTree,
  getDiscoveryTree as dbGetDiscoveryTree,
  saveMigrationPath as dbSaveMigrationPath,
  getMigrationPath as dbGetMigrationPath,
  listMigrationPaths as dbListMigrationPaths,
  saveSourceUrls as dbSaveSourceUrls,
  checkUrlFreshness as dbCheckUrlFreshness,
  pinKnowledgeVersion as dbPinKnowledgeVersion,
  getPinnedKnowledge as dbGetPinnedKnowledge,
  composeDiscoveryTree as dbComposeDiscoveryTree,
  composeHeuristics as dbComposeHeuristics,
...
export async function saveKnowledgePack(input: z.infer<typeof saveKnowledgePackSchema>) {
  const db = getDb();
...
export async function getKnowledgePack(input: z.infer<typeof getKnowledgePackSchema>) {
  const db = getDb();
...
export async function listKnowledgePacks(input: z.infer<typeof listKnowledgePacksSchema>) {
  const db = getDb();
...
export async function deleteKnowledgePack(input: z.infer<typeof deleteKnowledgePackSchema>) {
  const db = getDb();
...
export async function saveDiscoveryTreeKnowledge(input: z.infer<typeof saveDiscoveryTreeSchema>) {
  const db = getDb();
...
export async function getDiscoveryTreeKnowledge(input: z.infer<typeof getDiscoveryTreeSchema>) {
  const db = getDb();
...
export async function saveHeuristics(input: z.infer<typeof saveHeuristicsSchema>) {
  const db = getDb();
...
export async function getHeuristics(input: z.infer<typeof getHeuristicsSchema>) {
  const db = getDb();
...
export async function saveMigrationPath(input: z.infer<typeof saveMigrationPathSchema>) {
  const db = getDb();
...
export async function getMigrationPath(input: z.infer<typeof getMigrationPathSchema>) {
  const db = getDb();
...
export async function listMigrationPaths(input: z.infer<typeof listMigrationPathsSchema>) {
  const db = getDb();
...
export async function saveSourceUrls(input: z.infer<typeof saveSourceUrlsSchema>) {
  const db = getDb();
...
export async function saveAiAlternatives(input: z.infer<typeof saveAiAlternativesSchema>) {
  const db = getDb();
...
export async function pinKnowledgeVersion(input: z.infer<typeof pinKnowledgeVersionSchema>) {
  const db = getDb();
...
export async function getPinnedKnowledge(input: z.infer<typeof getPinnedKnowledgeSchema>) {
  const db = getDb();
...
export async function saveProficiencyCatalog(input: z.infer<typeof saveProficiencyCatalogSchema>) {
  const db = getDb();
...
export async function getComposedDiscoveryTree(input: z.infer<typeof getComposedDiscoveryTreeSchema>) {
  const db = getDb();
...
export async function getComposedHeuristics(input: z.infer<typeof getComposedHeuristicsSchema>) {
  const db = getDb();
...
export async function checkUrlFreshness(input: z.infer<typeof checkUrlFreshnessSchema>) {
  const db = getDb();
