import { z } from "zod";
import { getDb, saveChallengeReview as dbSaveChallengeReview, getChallengeReviews as dbGetChallengeReviews, } from "@migration-planner/db";
...
export async function saveChallengeReview(input) {
    const db = getDb();
...
export async function getChallengeReviews(input) {
    const db = getDb();
