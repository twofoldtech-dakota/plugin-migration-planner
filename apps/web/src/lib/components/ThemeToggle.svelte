...
<button
	onclick={toggle}
	class="brutal-border-thin flex h-9 w-9 items-center justify-center bg-surface text-text
		transition-transform hover:-translate-x-px hover:-translate-y-px hover:shadow-sm
