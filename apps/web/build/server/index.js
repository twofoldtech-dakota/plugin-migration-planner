...
import { D as DevalueError, i as is_primitive, g as get_type, a as is_plain_object, e as enumerable_symbols, s as stringify_key, b as stringify_string, v as valid_array_indices, u as uneval } from './chunks/index4-DG1itRH8.js';
import { w as writable, r as readable } from './chunks/index-mV5xf0Xo.js';
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets, nonce, env }) => '<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets + '/favicon.svg" type="image/svg+xml" />\n		<link rel="icon" href="' + assets + '/favicon.png" type="image/png" sizes="192x192" />\n		<link rel="apple-touch-icon" href="' + assets + '/apple-touch-icon.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		<meta name="theme-color" content="#4f46e5" />\n		<meta property="og:type" content="website" />\n		<meta property="og:title" content="MigrateIQ" />\n		<meta property="og:description" content="Digital experience migration planning — AI-powered discovery, risk analysis, and effort estimation for any tech stack." />\n		<meta property="og:image" content="' + assets + '/og-image.png" />\n		<meta property="og:image:width" content="1200" />\n		<meta property="og:image:height" content="630" />\n		<meta name="twitter:card" content="summary_large_image" />\n		<meta name="twitter:title" content="MigrateIQ" />\n		<meta name="twitter:description" content="Digital experience migration planning — AI-powered discovery, risk analysis, and effort estimation for any tech stack." />\n		<meta name="twitter:image" content="' + assets + `/og-image.png" />
		<script>
			(function() {
...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<title>500 — Server Error | MigrateIQ</title>
		<style>
			:root {
				--bg: #f0ece4;
				--surface: #ffffff;
	...
	<body>
		<div class="container">
			...
			<h1>Server Error</h1>
			<p>MigrateIQ encountered a critical error and couldn't render the page. This is usually temporary.</p>
			<div class="detail">
				<div class="detail-label">Error</div>
				<div class="detail-msg">` + message + '</div>\n			</div>\n			<a href="/">Back to Dashboard</a>\n		</div>\n	</body>\n</html>\n'
  },
  version_hash: "1ht22m"
};
