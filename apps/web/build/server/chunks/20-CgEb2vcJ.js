...
const load = async ({ params }) => {
  const reviews = await getChallengeReviews(db(), params.id, "estimate");
  return { reviews, step: "estimate" };
};
