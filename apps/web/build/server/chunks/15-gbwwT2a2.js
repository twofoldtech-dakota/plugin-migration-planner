...
const load = async ({ params }) => {
  const reviews = await getChallengeReviews(db(), params.id, "analysis");
  return { reviews, step: "analysis" };
};
